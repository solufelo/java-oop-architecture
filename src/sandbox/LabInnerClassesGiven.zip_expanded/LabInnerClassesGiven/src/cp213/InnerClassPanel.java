...
public class InnerClassPanel extends JPanel {
	...
	public void itemStateChanged(final ItemEvent e) {
	    ...
	    final String checkBoxText = source.getText();
	    
	    if (e.getStateChange() == ItemEvent.SELECTED) {
		// Add the checkbox text to the list if selected
		InnerClassPanel.this.checkBoxesSelected.add(checkBoxText);
	    } else if (e.getStateChange() == ItemEvent.DESELECTED) {
		// Remove the checkbox text from the list if deselected
		InnerClassPanel.this.checkBoxesSelected.remove(checkBoxText);
	    }
	    
	    // Update the label and print to console
	    final String display = Arrays.toString(InnerClassPanel.this.checkBoxesSelected.toArray());
	    InnerClassPanel.this.label.setText(display);
	...
	public void stateChanged(final ChangeEvent e) {
		...
		final String display = String.valueOf(InnerClassPanel.this.sliderSet);
		InnerClassPanel.this.label.setText(display);
		System.out.println(display);
	    }
	}
	...
	public void stateChanged(final ChangeEvent e) {
	    ...
	    InnerClassPanel.this.spinnerSet = source.getValue().toString();
